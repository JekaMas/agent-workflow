## 1. Extract remaining generic owners
- [x] 1.1 Move debugging/conflict, engineering/KB/provider guidance; retain product adapters.
- [x] 1.2 Share validator mechanisms with explicit local policy and preserve negative fixtures.
## 2. Simplify adoption
- [x] 2.1 Add automatic module discovery and reviewed existing-setup adoption.
