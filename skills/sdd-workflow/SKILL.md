...
For unresolved/recurrent failures use this package’s `skills/hypothesis-debugging/SKILL.md`; for requested merge/rebase/cherry-pick conflicts use `skills/conflict-resolution/SKILL.md`. Preserve task authority and continue the same change.
